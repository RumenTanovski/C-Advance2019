...
namespace Lab5FilterByAge
{
    class StartUp
    {
        ...
        static void Printer(KeyValuePair<string, int> person, string[] printerPatern)
        {
            if (printerPatern.Length == 2)
            {
                Console.WriteLine(printerPatern[0] == "name" ?
